 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed May 14 16:19:07 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                control_pi_dsp
...
extern void control_pi_dsp_Start_wrapper(void);
extern void control_pi_dsp_Outputs_wrapper(const real_T *Vref,
  const real_T *Vmeas,
  real_T *y0,
  real_T *error);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vref of S-Function control_pi_dsp");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vmeas of S-Function control_pi_dsp");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function control_pi_dsp");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port error of S-Function control_pi_dsp");
      return;
    }
...
{
  const real_T *Vref = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Vmeas = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *y0 = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *error = (real_T *) ssGetOutputPortRealSignal(S, 1);
  control_pi_dsp_Outputs_wrapper(Vref, Vmeas, y0, error);
}
